...
class Resume extends JFrame implements ActionListener {
    ...
    Resume() {
        super("Resume");
        this.p.getContentPane().setBackground(Color.orange);
        String[] var1 = new String[]{"Male", "Female","Binary"};
        ...
        this.city.setBounds(200, 260, 200, 30);
        this.emaill.setBounds(200, 310, 200, 30);
        this.skills.setBounds(200, 360, 200, 30);
        this.college.setBounds(200, 410, 200, 30);
        this.degree.setBounds(200, 460, 200, 30);
        this.experience.setBounds(200, 510, 200, 30);
        this.linkedln.setBounds(700, 10, 200, 30);
        this.github.setBounds(700, 50, 200, 30);
        this.hackerrnk.setBounds(700, 110, 200, 30);
        this.contact.setBounds(700, 160, 200, 30);
        this.p.add(this.fatherfullname);
        this.p.add(this.fatherfatherfullname);
        this.p.add(this.password);
        this.p.add(this.cpassword);
        this.p.add(this.city);
        ...
        JLabel var4 = new JLabel("INTERNSHIP");
        ...
        var11.setBounds(10, 410, 150, 30);
        var12.setBounds(10, 460, 150, 30);
        var13.setBounds(10, 510, 150, 30);
        var14.setBounds(500, 10, 150, 30);
        var15.setBounds(500, 60, 150, 30);
        var16.setBounds(500, 110, 150, 30);
        var17.setBounds(500, 160, 150, 30);
        ...
        this.p.add(var18, BorderLayout.WEST);
        this.p.add(var19, BorderLayout.EAST);

        var18.setBounds(500, 600, 100, 30);
        var19.setBounds(700, 600, 100, 30);
